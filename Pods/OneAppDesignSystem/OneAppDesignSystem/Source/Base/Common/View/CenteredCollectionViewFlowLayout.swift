...
public final class CenteredCollectionViewFlowLayout: UICollectionViewFlowLayout {
...
private extension CenteredCollectionViewFlowLayout {
    ...
    func attributesForRect(
        ...
        for attributes in layoutAttributes {
            ...
            switch scrollDirection {
            case .horizontal where abs(attributes.center.x - proposedCenterOffset) < abs((candidateAttributes?.center.x ?? .zero) - proposedCenterOffset):
                candidateAttributes = attributes
            case .vertical where abs(attributes.center.y - proposedCenterOffset) < abs((candidateAttributes?.center.y ?? .zero) - proposedCenterOffset):
                candidateAttributes = attributes
            default:
                continue
            }
