//
//  ContentListHorizontalBasicView.swift
//  OneAppDesignSystem
//
...
class ContentListHorizontalBasicView: UIView {

    // MARK: - IBOutlet
    @IBOutlet weak var contentImageView: UIImageView!
    @IBOutlet weak var widthContentImageConstraint: NSLayoutConstraint!
    @IBOutlet weak var heightContentImageConstraint: NSLayoutConstraint!
...
// MARK: - Action
extension ContentListHorizontalBasicView {
...
extension ContentListHorizontalBasicView: ContentListBasicViewInterface {
    var view: UIView {
        self
    }
...
// MARK: - Private
private extension ContentListHorizontalBasicView {
    func commonInit() {
        setupXib()
        setupUI()
    ...
    func updateContentImageSize() {
        let screenWidth = UIScreen.main.bounds.width
        let contentListScreen = ContentListHorizontalScreen(screenWidth: screenWidth)
        
        widthContentImageConstraint.constant = contentListScreen.contentImageViewWidth
        heightContentImageConstraint.constant = contentListScreen.contentImageViewHeight
